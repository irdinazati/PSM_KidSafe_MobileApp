  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Child Information', style: TextStyle(fontSize: 16, color: Colors.white))),
      ),
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildButton('Add Child Info', Colors.purple[200]!, _createChildInfo),
                    _buildButton('Update Child Info', Colors.purple[100]!, _updateChildInfo),
                  ],
                ),
              ],
            ),
