...
class _VehicleMonitoringPageState extends State<VehicleMonitoringPage> {
  ...
  String soundLevel = "Fetching Data..."; // Default sensor value
      ...
      if (response.statusCode == 200) {
        ...
        if (feeds.isNotEmpty) {
          setState(() {
            ...
            soundLevel = feeds[0]['field2'] ?? 'N/A';
            motion = feeds[0]['field3'] ?? 'N/A';
            isLoading = false;
          });
        } else {
          setState(() {
            temperature = 'No data available';
            soundLevel = 'No data available';
        ...
        setState(() {
          ...
          soundLevel = 'Error fetching data';
                    ...
                    : Column(
                        children: [
                          ...
                          SensorTile(
                            ...
                            value: soundLevel,
                            description: 'The app uses sound sensors installed in the car to identify any noises or sounds produced by the kid. When unusual noises are heard, carers are alerted, adding an extra degree of security by warning them of any possible danger or discomfort.'
                          ),
                          SensorTile(
