...
import '../Screens/signup_screen/reactivateAccount.dart';
  ...
  Future<UserCredential?> login(
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        ParentModel userModel = ParentModel.fromDoc(await getUserDoc(userCredential
            .user
            ?.uid)); // Get the user's status from Firestore using ParentModel.fromDoc
